...
• Live outstanding balances and available limits, straight from your bank's
  own messages

SUBSCRIPTIONS, EXPOSED
• Finds every recurring charge — ChatGPT, Netflix, Spotify, your gym
• Monthly total, price-rise alerts, and it even notices when one stops
• Tap any subscription for its full history and which card pays it
...
• الرصيد المستحق والحد المتاح مباشرة من رسائل بنكك

اشتراكاتك مكشوفة
• يكتشف كل اشتراك متكرر — ChatGPT ونتفليكس وسبوتيفاي وناديك الرياضي
• الإجمالي الشهري وتنبيه ارتفاع الأسعار ويلاحظ حتى توقف الاشتراك

افهم أموالك
• ميزانيات مع تحذير عند التجاوز
• تحليلات بلغة واضحة ورسوم بيانية بالأرقام
• شهرك المالي يبدأ يوم راتبك إن أردت
...
## Assets (docs/store-assets/)

- 6 phone screenshots, 1080×2160 (2:1, compliant): home, insights, charts,
  bills, subscription detail, wallet
- feature-graphic.png, 1024×500
- App icon: current in-app icon set; final adaptive-icon pass before submit
