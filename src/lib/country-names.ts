/**
 * ISO 3166-1 alpha-2 countries with their English and Arabic display names.
 *
 * Generated from CLDR (Node's Intl.DisplayNames, type "region") because Hermes
 * does not ship Intl.DisplayNames. Data only: a name here is a label and never
 * changes how a message or statement is read.
 */
export const COUNTRY_NAMES: Readonly<Record<string, readonly [en: string, ar: string]>> = Object.freeze({
  AD: ["Andorra", "أندورا"],
