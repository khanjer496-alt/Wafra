...
const S = {
  ...
  notifDiagnosticsVisible: { en: 'Android exposes {active} active notifications · trusted banks: {trusted} · ADCB visible: {adcb}', ar: 'يعرض أندرويد {active} إشعاراً نشطاً · بنوك موثوقة: {trusted} · ADCB ظاهر: {adcb}' },
