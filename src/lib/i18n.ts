...
const S = {
  ...
  onboardWelcomeBody: { en: 'Supported bank activity becomes one clear ledger. Prefer manual? Start there instead.', ar: 'يتحوّل نشاط البنك المدعوم إلى سجل واضح واحد. وإن فضّلت الإدخال اليدوي، ابدأ به.' },
