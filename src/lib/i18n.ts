...
const S = {
  ...
  iosMessageSetupSubtitle: { en: 'Keep new bank alerts automatic. Then import past messages if you want.', ar: 'اجعل تنبيهات البنك الجديدة تلقائية، ثم استورد الرسائل السابقة إذا أردت.' },
