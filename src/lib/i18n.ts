...
const S = {
  ...
  onboardWelcomeBody: {
    en: 'Bank alerts arrive messy. Wafra turns them into one picture you can actually understand.',
    ar: 'تصل تنبيهات البنك متفرقة. يحوّلها وفرة إلى صورة واحدة يمكنك فهمها فعلاً.',
  },
  ...
  onboardTrackingOneView: { en: 'One clear money view.', ar: 'صورة مالية واحدة وواضحة.' },
  onboardTrackingSpreadsheetScene: { en: 'Keep the structure. Lose the cleanup.', ar: 'احتفظ بالبنية وتخلّص من الترتيب اليدوي.' },
  onboardTrackingFinanceScene: { en: 'Keep the clarity without handing over a bank login.', ar: 'احتفظ بالوضوح دون مشاركة تسجيل الدخول إلى البنك.' },
  onboardTrackingFreshSceneTitle: { en: 'Start clean.', ar: 'ابدأ بصورة نظيفة.' },
  onboardTrackingFreshSceneBody: { en: 'Your first real entry can become the beginning of the picture.', ar: 'يمكن لأول عملية حقيقية أن تكون بداية صورتك المالية.' },
  ...
  onboardSceneAlertsToPicture: { en: '3 ALERTS, 1 PICTURE', ar: '3 تنبيهات، صورة واحدة' },
  ...
  onboardNameTitle: { en: 'What should Wafra call you?', ar: 'بماذا تحب أن يناديك وفرة؟' },
  onboardNameBody: {
    en: 'A first name or nickname is enough. It stays on this device.',
    ar: 'يكفي الاسم الأول أو اسم تفضّله. سيبقى على هذا الجهاز.',
  },
  ...
  onboardNameContinue: { en: 'Continue with my name', ar: 'تابع باسمي' },
  ...
  onboardTrackingBody: { en: 'Choose what feels closest to your life now. The scene — and your starting view — changes with you.', ar: 'اختر ما يشبه طريقتك اليوم. سيتغيّر المشهد وصورتك الأولى مع اختيارك.' },
  ...
  onboardIntentionBody: { en: 'Pick the feeling you want Wafra to help you get to first.', ar: 'اختر النتيجة التي تريد أن يساعدك وفرة للوصول إليها أولاً.' },
  ...
  onboardIntentionControlScene: { en: 'Everything in one place. Nothing to chase.', ar: 'كل شيء في مكان واحد، دون ملاحقة التفاصيل.' },
  onboardIntentionSpendScene: { en: 'See the habit early, before it becomes the month.', ar: 'شاهد نمط الإنفاق مبكراً قبل أن يتحول إلى شهر كامل.' },
  onboardIntentionAheadScene: { en: 'Due dates line up before they can surprise you.', ar: 'تصطف مواعيد الاستحقاق أمامك قبل أن تفاجئك.' },
  onboardIntentionBufferScene: { en: 'Keep more space between today and zero.', ar: 'اترك مساحة أكبر بين اليوم والوصول إلى الصفر.' },
  onboardPreviewFrom: { en: 'FROM YOUR CURRENT HABIT', ar: 'من طريقتك الحالية' },
  onboardPreviewForYou: { en: 'SHAPED AROUND YOU', ar: 'مصممة حولك' },
  ...
  onboardPersonalizedBody: {
    en: 'You told Wafra what matters and how you manage money today. Here is how your setup will start.',
    ar: 'أخبرت وفرة بما يهمك وكيف تدير أموالك اليوم. هكذا ستبدأ تجربتك.',
  },
  onboardBasedOnAnswers: { en: 'BASED ON YOUR ANSWERS', ar: 'بناءً على إجاباتك' },
  onboardConnectMyMoney: { en: 'Connect my money', ar: 'اربط نشاطي المالي' },
  ...
  onboardCompleteAutomaticTitle: { en: 'Your money picture is ready to build.', ar: 'صورتك المالية جاهزة للبناء.' },
  ...
  onboardCompleteBodyAutomatic: {
    en: 'Automatic tracking is ready. Open Wafra and your first history import will build your money picture in the background while the app stays usable.',
    ar: 'التتبع التلقائي جاهز. افتح وفرة وسيبني أول استيراد للسجل صورتك المالية في الخلفية مع بقاء التطبيق قابلاً للاستخدام.',
  },
