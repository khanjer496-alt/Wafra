...
const S = {
  ...
  localAiTitle: { en: 'Local AI lab', ar: 'مختبر الذكاء المحلي' },
  localAiSettingsDetail: {
    en: 'Private shadow tests · never changes your ledger',
    ar: 'اختبارات خاصة في الظل · لا تغيّر سجلك',
  },
  localAiUnavailable: {
    en: 'This internal evaluation tool is not included in this build.',
    ar: 'أداة التقييم الداخلية غير مشمولة في هذا الإصدار.',
  },
  localAiShadowTitle: { en: 'Evaluation only', ar: 'للتقييم فقط' },
  localAiShadowBody: {
    en: 'The model runs on this phone and cannot add, edit, hide or categorise a transaction. Wafra will not enable it for capture until it passes the safety benchmark and a larger held-out corpus.',
    ar: 'يعمل النموذج على هذا الهاتف ولا يمكنه إضافة عملية أو تعديلها أو إخفاءها أو تصنيفها. لن تفعّله وفرة للالتقاط حتى يجتاز اختبار الأمان ومجموعة اختبار مستقلة أكبر.',
  },
  localAiModelHeader: { en: 'ON-DEVICE MODEL', ar: 'النموذج على الجهاز' },
  localAiModelBody: {
    en: 'Optional download from the official Qwen repository. The file is checksum-verified, stays in disposable app cache, and is never backed up with your ledger.',
    ar: 'تنزيل اختياري من مستودع Qwen الرسمي. يُتحقق من بصمة الملف ويبقى في ذاكرة التطبيق المؤقتة ولا يُنسخ مع سجلك.',
  },
  localAiInstalled: { en: 'Installed · {size} GB', ar: 'مثبّت · {size} غ.ب' },
  localAiNotInstalled: { en: 'Not downloaded · about 1.04 GB', ar: 'غير منزّل · نحو ١٫٠٤ غ.ب' },
  localAiInvalid: { en: 'File needs a fresh verified download', ar: 'يحتاج الملف إلى تنزيل جديد موثّق' },
  localAiDownload: { en: 'Download evaluation model', ar: 'نزّل نموذج التقييم' },
  localAiDownloading: { en: 'Downloading model…', ar: 'جارٍ تنزيل النموذج…' },
  localAiVerifying: { en: 'Verifying model…', ar: 'جارٍ التحقق من النموذج…' },
  localAiLoading: { en: 'Loading model…', ar: 'جارٍ تحميل النموذج…' },
  localAiRunning: { en: 'Running locally…', ar: 'جارٍ التشغيل محلياً…' },
  localAiDownloadFailed: { en: 'Model download did not finish', ar: 'لم يكتمل تنزيل النموذج' },
  localAiStorageFailed: {
    en: 'Free at least 1.6 GB on this phone, then try again.',
    ar: 'وفّر ما لا يقل عن ١٫٦ غ.ب على هذا الهاتف ثم حاول مجدداً.',
  },
  localAiTryAgain: {
    en: 'No ledger data changed. Check the connection and available storage, then try again.',
    ar: 'لم تتغير بيانات السجل. تحقق من الاتصال والمساحة المتاحة ثم حاول مجدداً.',
  },
  localAiRemove: { en: 'Remove downloaded model', ar: 'احذف النموذج المنزّل' },
  localAiRemoveQuestion: { en: 'Remove the local model?', ar: 'حذف النموذج المحلي؟' },
  localAiRemoveBody: {
    en: 'This frees about 1.04 GB. Your ledger and parser are not affected.',
    ar: 'سيؤدي ذلك إلى توفير نحو ١٫٠٤ غ.ب. لن يتأثر سجلك أو المحلل.',
  },
  localAiBenchmarkHeader: { en: 'ADVERSARIAL SAFETY GATE', ar: 'بوابة اختبار الأمان' },
  localAiBenchmarkBody: {
    en: 'Runs synthetic salary, purchase, transfer, card-payment, bill, refund, ATM and non-posting alerts from multiple regions. Passing this small set still does not enable the model.',
    ar: 'يشغّل تنبيهات اصطناعية للراتب والشراء والتحويل وسداد البطاقة والفاتورة والاسترداد والصراف والتنبيهات غير المنفذة من مناطق متعددة. اجتياز هذه المجموعة الصغيرة لا يفعّل النموذج.',
  },
  localAiBenchmarkAction: { en: 'Run safety benchmark', ar: 'شغّل اختبار الأمان' },
  localAiBenchmarkProgress: {
    en: 'Testing {completed} of {total}',
    ar: 'اختبار {completed} من {total}',
  },
  localAiGatePassed: { en: 'Small safety gate passed', ar: 'تم اجتياز بوابة الأمان الصغيرة' },
  localAiGateFailed: { en: 'Not safe for ledger use', ar: 'غير آمن للاستخدام في السجل' },
  localAiBenchmarkResult: {
    en: '{exact} of {total} exact · {safety} safety failures',
    ar: '{exact} من {total} صحيحة · {safety} إخفاقات أمان',
  },
  localAiSingleHeader: { en: 'TRY ONE ALERT', ar: 'جرّب تنبيهاً واحداً' },
  localAiSingleBody: {
    en: 'Paste an alert to inspect the model’s structured opinion. The text stays in memory, is not uploaded or saved, and is cleared immediately after inference.',
    ar: 'الصق تنبيهاً لفحص رأي النموذج المنظم. يبقى النص في الذاكرة ولا يُرفع أو يُحفظ ويُمسح فور انتهاء الاستدلال.',
  },
  localAiInputA11y: { en: 'Bank alert to evaluate locally', ar: 'تنبيه بنكي للتقييم محلياً' },
  localAiInputPlaceholder: { en: 'Paste one bank alert', ar: 'الصق تنبيهاً بنكياً واحداً' },
  localAiSingleAction: { en: 'Evaluate on this phone', ar: 'قيّم على هذا الهاتف' },
  localAiVerdict: { en: 'Model opinion — not ledger data', ar: 'رأي النموذج — ليس من بيانات السجل' },
  localAiRunFailed: { en: 'Local evaluation stopped', ar: 'توقف التقييم المحلي' },
  assistantTitle: { en: 'Ask Wafra', ar: 'اسأل وفرة' },
  assistantSettingsDetail: {
    en: 'Find entries and explain your ledger on this device',
    ar: 'ابحث عن العمليات وافهم سجلك على هذا الجهاز',
  },
  assistantPrivacy: {
    en: 'Read-only · answers come from your ledger · nothing is uploaded',
    ar: 'للقراءة فقط · الإجابات من سجلك · لا يتم رفع شيء',
  },
  assistantWelcomeTitle: { en: 'What do you want to understand?', ar: 'ماذا تريد أن تفهم؟' },
  assistantWelcomeBody: {
    en: 'Ask about income, spending, transfers, cash out, bills or a specific transaction.',
    ar: 'اسأل عن الدخل أو الإنفاق أو التحويلات أو النقد الخارج أو الفواتير أو عملية محددة.',
  },
  assistantPromptTalabat: { en: 'Show my Talabat income this month', ar: 'اعرض دخل طلبات هذا الشهر' },
  assistantPromptCashOut: { en: 'Why is my cash out this amount?', ar: 'لماذا النقد الخارج بهذا المبلغ؟' },
  assistantPromptBills: { en: 'Which bills are still due?', ar: 'ما الفواتير التي ما زالت مستحقة؟' },
  assistantPromptLarge: { en: 'Find transactions above 500', ar: 'ابحث عن العمليات فوق ٥٠٠' },
  assistantInputPlaceholder: { en: 'Ask about your money', ar: 'اسأل عن أموالك' },
  assistantSend: { en: 'Ask', ar: 'اسأل' },
  assistantThinking: { en: 'Reading your ledger…', ar: 'جارٍ قراءة سجلك…' },
  assistantModelNeededTitle: { en: 'Ask more flexible questions', ar: 'اسأل بأسلوب أكثر مرونة' },
  assistantModelNeededBody: {
    en: 'Download the optional 1.04 GB model. It interprets your question locally; Wafra still performs every search and calculation.',
    ar: 'نزّل النموذج الاختياري بحجم ١٫٠٤ غ.ب. يفهم سؤالك محلياً بينما تنفّذ وفرة كل بحث وحساب.',
  },
  assistantDownloadModel: { en: 'Download private model', ar: 'نزّل النموذج الخاص' },
  assistantModelReady: { en: 'Private model ready', ar: 'النموذج الخاص جاهز' },
  assistantQuestionLabel: { en: 'Your question', ar: 'سؤالك' },
  assistantAnswerLabel: { en: 'Wafra answer', ar: 'إجابة وفرة' },
  assistantSources: { en: 'SOURCE ENTRIES', ar: 'العمليات المصدرية' },
  assistantOpenEntry: { en: 'Open source entry', ar: 'افتح العملية المصدرية' },
  assistantOpenBills: { en: 'Open Bills', ar: 'افتح الفواتير' },
  assistantFallbackNote: {
    en: 'The model could not form a safe query, so Wafra used a narrower local search.',
    ar: 'لم يتمكن النموذج من تكوين بحث آمن، لذا استخدمت وفرة بحثاً محلياً أضيق.',
  },
  assistantNoMatchesTitle: { en: 'No matching entries', ar: 'لا توجد عمليات مطابقة' },
  assistantNoMatchesBody: {
    en: 'Try the exact merchant, payer or account name, or choose a different period.',
    ar: 'جرّب اسم التاجر أو الدافع أو الحساب بدقة، أو اختر فترة مختلفة.',
  },
  assistantUnsupportedTitle: { en: 'I could not apply that safely', ar: 'تعذر تطبيق هذا الطلب بأمان' },
  assistantInvalidAmountBody: {
    en: 'Use a positive amount with the same decimal precision as your ledger currency.',
    ar: 'استخدم مبلغاً موجباً بنفس عدد المنازل العشرية لعملة سجلك.',
  },
  assistantHistoricalBillsBody: {
    en: 'Current reminders are available here. For payment history, name the biller so Wafra can show its exact source entries.',
    ar: 'تتوفر التذكيرات الحالية هنا. لسجل السداد، اذكر اسم الجهة لتعرض وفرة العمليات المصدرية بدقة.',
  },
  assistantAmbiguousQueryBody: {
    en: 'I could not preserve the specific name in that question. Try the exact merchant, payer or account name.',
    ar: 'تعذر الاحتفاظ بالاسم المحدد في السؤال. جرّب اسم التاجر أو الدافع أو الحساب بدقة.',
  },
  assistantFoundTitle: { en: '{count} matching entries', ar: '{count} عمليات مطابقة' },
  assistantFoundBody: {
    en: '{period} · counted total {sign}{total}. Transfers and hidden-account rows do not change this total.',
    ar: '{period} · الإجمالي المحتسب {sign}{total}. التحويلات وعمليات الحسابات المخفية لا تغيّر هذا الإجمالي.',
  },
  assistantSummaryBody: {
    en: 'Income {income} · spent {spending} · net {sign}{net}. Own-account transfers and card repayments are excluded.',
    ar: 'الدخل {income} · الإنفاق {spending} · الصافي {sign}{net}. تُستبعد تحويلات حساباتك وسداد البطاقات.',
  },
  assistantCashOutTitle: { en: 'Cash out {amount}', ar: 'النقد الخارج {amount}' },
  assistantCashOutBody: {
    en: 'Card repayments {cards} · bank, debit and cash {accounts} · {count} source entries. Each settlement is counted once.',
    ar: 'سداد البطاقات {cards} · البنك والخصم والنقد {accounts} · {count} عمليات مصدرية. يُحتسب كل سداد مرة واحدة.',
  },
  assistantNoBillsTitle: { en: 'No saved bills in this period', ar: 'لا توجد فواتير محفوظة في هذه الفترة' },
  assistantNoBillsBody: {
    en: 'Wafra only reports reminders already supported by your ledger.',
    ar: 'تعرض وفرة فقط التذكيرات الموجودة فعلاً في سجلك.',
  },
  assistantBillsTitle: { en: '{count} bills still open', ar: '{count} فواتير ما زالت مفتوحة' },
  assistantBillsBody: { en: '{total} remains due from saved reminders.', ar: 'المتبقي {total} من التذكيرات المحفوظة.' },
  assistantNoRecurringTitle: { en: 'No active recurring entries found', ar: 'لم يتم العثور على عمليات متكررة نشطة' },
  assistantNoRecurringBody: {
    en: 'Wafra needs repeated posted payments before it calls something recurring.',
    ar: 'تحتاج وفرة إلى دفعات منفذة ومتكررة قبل اعتبار العملية متكررة.',
  },
  assistantRecurringTitle: { en: '{count} active recurring entries', ar: '{count} عمليات متكررة نشطة' },
  assistantRecurringBody: { en: 'About {total} per month in total.', ar: 'نحو {total} شهرياً إجمالاً.' },
  assistantPaid: { en: 'Paid', ar: 'مدفوع' },
  assistantDue: { en: 'Due {date}', ar: 'مستحق {date}' },
  assistantUnavailable: {
    en: 'The private assistant is not included in this build.',
    ar: 'المساعد الخاص غير مشمول في هذا الإصدار.',
  },
