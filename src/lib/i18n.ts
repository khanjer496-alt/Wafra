...
const S = {
  ...
  iosMessageGuideEntry: {
    en: 'Automation tab → + → Message',
    ar: 'تبويب الأتمتة ← + ← رسالة',
  },
  ...
  iosMessageFutureInstallHelp: { en: '1. Add {shortcut}. Next, check permissions, then connect new messages.', ar: '١. أضف {shortcut}. بعدها افحص الأذونات ثم اربط الرسائل الجديدة.' },
  iosMessageFutureReturnHelp: { en: 'Added {shortcut}?', ar: 'أضفت {shortcut}؟' },
  iosMessagePermissionTitle: { en: '2. Check Shortcut permissions', ar: '٢. افحص أذونات الاختصار' },
  iosMessageRunPermissionCheck: { en: 'Run setup check', ar: 'تشغيل فحص الإعداد' },
  iosMessagePermissionBody: { en: 'Run the Shortcut once with this iPhone unlocked. Allow access to Wafra when Apple asks, then return here. This checks the Shortcut; your first bank alert confirms automatic delivery.', ar: 'شغّل الاختصار مرة واحدة والآيفون مفتوح. اسمح بالوصول إلى وفرة عندما تطلب Apple ذلك، ثم عد إلى هنا. هذا يفحص الاختصار؛ ويؤكد أول تنبيه بنكي وصول الرسائل تلقائياً.' },
