...
const S = {
  ...
  pendingTransfersIncluded: {
    en: '{count} transfer{s} awaiting review included in this Net. Own-account moves will be removed when confirmed.',
    ar: 'يتضمن هذا الصافي {count} تحويلات بانتظار المراجعة. ستُستبعد التحويلات بين حساباتك عند تأكيدها.',
  },
  ...
  onboardHeadline: { en: 'Your money,\nunderstood.', ar: 'أموالك،\nبوضوح.' },
  onboardWelcomeBody: { en: 'Supported bank alerts become a private ledger on your phone. No bank login required.', ar: 'تتحول تنبيهات البنوك المدعومة إلى سجل خاص على هاتفك. دون تسجيل دخول إلى البنك.' },
  onboardValueAlerts: { en: 'Capture what happened', ar: 'التقط ما حدث' },
  onboardValueAlertsBody: { en: 'Supported purchases, income, transfers and statements.', ar: 'المشتريات والدخل والتحويلات والكشوف المدعومة.' },
  onboardValueOrganized: { en: 'Organized automatically', ar: 'تنظيم تلقائي' },
  onboardValueOrganizedBody: { en: 'Merchants, categories, cards and accounts stay connected.', ar: 'تبقى المتاجر والتصنيفات والبطاقات والحسابات مترابطة.' },
  onboardValuePicture: { en: 'See the useful picture', ar: 'شاهد الصورة المفيدة' },
  onboardValuePictureBody: { en: 'In, out, net, spending and upcoming payments.', ar: 'الدخل والإنفاق والصافي والمصروفات والدفعات القادمة.' },
  ...
  onboardAutomaticChoiceIos: { en: 'Set up Apple Shortcuts', ar: 'إعداد اختصارات Apple' },
  onboardAutomaticChoiceIosBody: { en: 'Set up local bank alerts. Past messages can wait.', ar: 'أعدّ تنبيهات البنك محلياً. يمكنك تأجيل الرسائل السابقة.' },
  ...
  historyLocalProcessing: { en: 'Checks readable messages saved on this iPhone. Requires fewer than 3,000 messages and confirmed coverage. Processing stays on this device.', ar: 'يفحص الرسائل القابلة للقراءة والمحفوظة على هذا الآيفون. يتطلب أقل من ٣٠٠٠ رسالة وتغطية مؤكدة. تتم المعالجة على الجهاز.' },
  historyReadyCompact: {
  ...
  historyFirstRunGuidance: { en: 'Choose Always Allow. Large histories can take 20–25 minutes. Keep Shortcuts open and iPhone unlocked.', ar: 'اختر «السماح دائماً». قد يستغرق السجل الكبير ٢٠–٢٥ دقيقة. أبقِ الاختصارات مفتوحاً والآيفون دون قفل.' },
  historyContinueBody: { en: 'Continue in Shortcuts. Keep iPhone unlocked. Large histories can take 20–25 minutes.', ar: 'تابع في الاختصارات. أبقِ الآيفون دون قفل. قد يستغرق السجل الكبير ٢٠–٢٥ دقيقة.' },
  historyReviewBody: {
  ...
  iosMessageSetupSubtitle: { en: 'Set up new alerts. Past messages can wait.', ar: 'أعدّ التنبيهات الجديدة. يمكنك تأجيل الرسائل السابقة.' },
  iosMessageFutureTitle: {
    en: 'Future alerts',
    ar: 'التنبيهات المستقبلية',
  },
  ...
  iosMessagePastTiming: { en: 'Large histories: 20–25 min', ar: 'السجل الكبير: ٢٠–٢٥ دقيقة' },
  ...
  iosMessageHistoryCoverage: { en: 'Under 3,000 saved messages.', ar: 'أقل من ٣٠٠٠ رسالة محفوظة.' },
  ...
  iosMessageFutureInstallHelp: { en: 'Add the Shortcut, then return here.', ar: 'أضف الاختصار ثم عد هنا.' },
  ...
  iosMessageHistoryStartHelp: { en: 'Shortcuts reads and extracts messages first. Review appears in Wafra after return.', ar: 'يقرأ تطبيق الاختصارات الرسائل ويستخرجها أولاً. تظهر المراجعة في وفرة بعد العودة.' },
  ...
  iosMessageHistoryRunningHelp: { en: 'Extraction happens in Shortcuts first. Keep it open and your iPhone unlocked. Review appears in Wafra after return.', ar: 'يتم استخراج الرسائل في تطبيق الاختصارات أولاً. أبقه مفتوحاً والآيفون دون قفل. تظهر المراجعة في وفرة بعد العودة.' },
  ...
  iosMessageHelpCoverage: { en: 'Under 3,000 messages. Incomplete coverage stops the import.', ar: 'أقل من ٣٠٠٠ رسالة. يتوقف الاستيراد إذا لم تكتمل التغطية.' },
