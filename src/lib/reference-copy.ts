...
export const spendingTrendsCopy = {
  en: { cashflow: 'Income & spending', sixMonths: 'Six money months', income: 'Income', spending: 'Spending', net: 'Net',
    ...
    spentLess: 'less than', spentMore: 'more than', spentSame: 'About the same as', byThisDay: 'by this point', youSpent: 'You’ve spent',
  ...
  ar: { cashflow: 'الدخل والإنفاق', sixMonths: 'ستة أشهر مالية', income: 'الدخل', spending: 'الإنفاق', net: 'الصافي',
    ...
    spentLess: 'أقل من', spentMore: 'أكثر من', spentSame: 'تقريباً مثل', byThisDay: 'حتى هذه المرحلة', youSpent: 'أنفقت',
...
export const homeSummaryCopy = {
  en: { balance: 'Recorded balances', net: 'Net after spending', notBalance: 'Income minus spending · not your bank balance',
    ...
    leftToSpend: 'Left in budgets', overBudget: 'Over budgets by', perDay: 'a day', dayLeft: 'day left', daysLeft: 'days left',
    dailyAverage: 'Daily average', over: 'over', day: 'day', days: 'days', thisWeek: 'This week', weekTotal: 'This week, total',
  ...
  ar: { balance: 'الأرصدة المسجلة', net: 'الصافي بعد الإنفاق', notBalance: 'الدخل ناقص الإنفاق · ليس رصيد البنك',
    ...
    leftToSpend: 'المتبقي في الميزانيات', overBudget: 'تجاوز الميزانيات بمقدار', perDay: 'يومياً', dayLeft: 'يوم متبقٍ', daysLeft: 'أيام متبقية',
    dailyAverage: 'المتوسط اليومي', over: 'خلال', day: 'يوم', days: 'أيام', thisWeek: 'هذا الأسبوع', weekTotal: 'هذا الأسبوع، المجموع',
    weekday: (day: number) => ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت'][day] ?? '' },
};
