...
// stable).
export const PaymentAgenda = React.memo(function PaymentAgenda({ items, accounts = EMPTY_ACCOUNTS, includePaid, group: selectedGroup, onOpen, renderMeta, showNote = true }: {
