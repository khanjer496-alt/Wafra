...
for (const language of ['en', 'ar']) {
  test(`${language}: notice states both pending totals and review effect, and has one accessible action`, () => {
    ...
    assert.ok(notice.props.accessibilityLabel.includes(h.words.noticeBody), 'full accounting explanation remains accessible');
