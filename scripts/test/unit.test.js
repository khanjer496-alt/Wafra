...
eq('parseAmountToFils Arabic decimal separator', fmt.parseAmountToFils('٣٥٠٫٥٠'), 35050);
eq('parseAmountToFils Arabic grouping and decimals', fmt.parseAmountToFils('١٬٢٣٤٫٥٦'), 123456);
eq('parseAmountToFils Persian grouping and decimals', fmt.parseAmountToFils('۱٬۲۳۴٫۵۶'), 123456);
eq('parseAmountToFils Arabic excess precision is rejected', fmt.parseAmountToFils('١٫٢٣٤'), null);
eq('parseAmountToFils Arabic bad grouping is rejected', fmt.parseAmountToFils('١٢٬٣٤'), null);
eq('parseAmountToFils Arabic zero is rejected', fmt.parseAmountToFils('٠'), null);
