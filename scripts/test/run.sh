...
SUITES+=(merchant-logo-resolver)
SUITES+=(bank-logo-resolver)
...
SUITES+=(global-alert-adversarial)
...
SUITES+=(country)
SUITES+=(best-effort-autopost)
SUITES+=(public-alert-evidence)
