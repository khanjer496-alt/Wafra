...
for f in types routes format categories ledger bill-alias capture-source-identity dedupe arabic-sms bank-amount-tokens sms-parser import-plan bills \
         ...
         universal-types universal-dates universal-fields universal-money universal-parser universal-confidence universal-template-certification universal-import brand-categories universal-categorization ai-alert-words ai-alert-cues ai-alert-gates ai-alert-flags ai-alert-model-manifest ai-alert-model ai-alert-extractor ai-alert-platform-reader ai-alert-reader ai-alert-prefill-queue learned-alert-formats learned-format-capture \
