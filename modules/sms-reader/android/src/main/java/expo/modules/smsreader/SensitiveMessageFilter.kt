...
/**
 * Small native boundary for security credentials. READ_SMS necessarily lets
 * Android return message text to this process, but these bodies must never
 * cross the native bridge, enter the delivery buffer, show a banner or reach
 * application storage. The JavaScript parser repeats the refusal defensively.
 */
